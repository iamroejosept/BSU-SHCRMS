...
require '../../php/centralConnection.php';
 ...
 if($_SERVER['REQUEST_METHOD'] == 'GET'){
        if($_GET["type"] == "checkRecords"){
            $query ="SELECT * FROM ConsultationInfo";  
            $result = mysqli_query($connect, $query);
        }else if($_GET["type"] == "checkArchivedConsultation"){
            $query ="SELECT * FROM archivedconsultation";  
            $result = mysqli_query($connect, $query);
        }  
    }
    $type = $_GET["type"];
        ...
        // ---------------------------start functions for System Logs---------------------------------------
            ...
            function editTableNav(y){
                if(y == "checkArchived"){
                    ...
                    document.getElementById('tab1').innerHTML = '&bull;&nbsp;Consultation History&nbsp;&bull;';
                }
            }
                ...
                buttons: [                              
                    {
                        extend:'print',
                        text:'Print Report',
                        title:"<h1 style='text-align:center;'>Consultation History</h1>",
                        exportOptions: {
                            columns: [0,1,2,3,4]
                        }           
                    },
    ...
    <nav>
      ...
      <a href="#" id="nav7" onclick="logout()" class="nav-pages">Logout</a>
        ...
        <div class="cont container">
            <div class="tabs">
                <div class="tabs-head">
                    <span id="tab1" class="tabs-toggle is-active">&bull;&nbsp;Consultation History&nbsp;&bull;</span>
                </div>
                <div id="notif">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($type == 'checkRecords'){
                                            echo "
                                            <a class='viewBTN btn btn-primary btn-sm' onclick='userViewRecord($row[IdNumb])' href='pages/newConsultation.php?num=$row[Num]&type=viewCons'>View</a>
                                            ...
                                            echo "
                                            <a class='viewBTN btn btn-primary btn-sm' onclick='userViewRecord($row[IdNumb])' href='pages/newConsultation.php?num=$row[Num]&type=viewArchivedCons'>View</a>
